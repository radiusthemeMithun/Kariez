...
$project_subtitle = get_post_meta( $id, 'rt_project_subtitle', true );
...
<article id="post-<?php the_ID(); ?>">
	<div class="project-item">
		...
		<div class="project-content">
			...
			<?php if ( kariez_option( 'rt_project_subtitle' ) ) { ?>
				<div class="project-subtitle"><?php kariez_html( $project_subtitle , false ); ?></div>
			<?php } ?>
