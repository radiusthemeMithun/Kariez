...
class WalkerNav extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$_mega_menu = get_post_meta( $item->ID, 'kariez_mega_menu', true );
		if ( ! empty( $_mega_menu ) ) {
			$classes[] = $_mega_menu;
		}
		...
		$caret       = '<svg width="9" height="5" viewBox="0 0 9 5" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M0.75 0.625L4.5 4.375L8.25 0.625" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
					</svg>';
